  ...
  const navBarItems = [
    ...
    },
    {
      ...
      subMenu: [
        ...
        {
          icon: <UserIcon />,
          text: 'All Pending Cases',
          url: '/pendingcases'
        },
        {
           icon: <UserIcon />,
          text:'All case History'
        },
        {
          icon: <UserIcon />,
    ...
    },
    {
      ...
      subMenu: [
        ...
        {
          icon: <UserIcon />,
          text: 'My Upcoming Hearings',
        },
        {
          icon: <UserIcon />,
          text: 'My hearing History',
        },
      ],
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <h1 class='text-xl text-white'>ProLex</h1>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav class='mt-2 py-2 px-4 lg:mt-4 lg:px-6'>
